...
typedef BlocWidgetSideEffectHandler<E extends SideEffect> =
    void Function(BuildContext context, E sideEffect);

class BlocSideEffectHandler<
  ...
  BlocSideEffectHandler({
    ...
    super.child,
         ...
         listenWhen: (previous, current) =>
             ...
             !listEquals(previous.sideEffects, current.sideEffects),
