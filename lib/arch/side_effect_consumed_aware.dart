...
mixin SideEffectConsumedAware<S extends WithSideEffects<dynamic, SideEffect>>
    on BlocBase<S> {
  @protected
  ...
  void onChange(Change<S> change) {
    ...
    if (change.currentState.sideEffects.length -
            change.nextState.sideEffects.length ==
        1) {
